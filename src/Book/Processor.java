...
public class Processor {
        ...
        exercise_Book.BookList bookList = new exercise_Book.BookList();
        ...
        while (true) {
            ...
            switch (choice) {
                case 1 -> {
                    ...
                    bookList.addBook(new exercise_Book.TextBook(idT, titleT, priceT, subject));
                }
                case 2 -> {
                    System.out.print("Enter id: ");
                    ...
                    bookList.addBook(new exercise_Book.ReferenceBook(idR, titleR, priceR, publisher));
                }
                case 3 -> {
                ...
                case 5 -> {
                    ...
                    exercise_Book.Book found = bookList.findBookById(idF);
                    if (found != null) found.displayDetails();
                    else System.out.println("Book not found!");
                }
                case 6 -> bookList.displayAllBooks();
                case 7 -> {
                    exercise_Book.Book expensive = bookList.findMostExpensiveBook();
                    if (expensive != null) {
